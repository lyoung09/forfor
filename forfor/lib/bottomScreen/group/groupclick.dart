          ...
          child: Obx(() => Column(
                ...
                children: <Widget>[
                  ...
                  InkWell(
                    child: Row(
                      children: <Widget>[
                        Checkbox(value: label[0].value, onChanged: (value) {}),
                        Text("Event"),
                      ],
                    ),
                    onTap: () {
                      label[0].value = !label[0].value;
                    },
                  ),
                  InkWell(
                    child: Row(
                      children: <Widget>[
                        Checkbox(value: label[1].value, onChanged: (value) {}),
                        Text("Personal"),
                      ],
                    ),
                    onTap: () {
                  ...
                  InkWell(
                    child: Row(
                      children: <Widget>[
                        Checkbox(value: label[2].value, onChanged: (value) {}),
                        Text("Reminder"),
                      ],
                    ),
                    onTap: () {
                      label[2].value = !label[2].value;
                    },
                  ),
                  InkWell(
                    child: Row(
                      children: <Widget>[
                        Checkbox(value: label[3].value, onChanged: (value) {}),
                        Text("Work"),
                      ],
                    ),
                    onTap: () {
                      label[3].value = !label[3].value;
                    },
                  ),
                  Container(
                    padding: EdgeInsets.symmetric(horizontal: 15, vertical: 15),
